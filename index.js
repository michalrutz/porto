        ...
        list.push(
            ...
            <div id='${(i)+"project"}' class="singleProject ${i%2===0 ? "odd" : ""}">
                ...
                <h3 href="${project.link}" class="title">${project.title}</h3>
                    ...
                    <p>${project.desc}</p>
                    <button class="singleProject_frame_btn" type="button" onclick="window.location.href='${project.link}';">take a peek →</button>
                </div>
                <a href="${project.link}"><img src="${project.img}" class="view"></img></a>
